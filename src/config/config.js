...
const envVarsSchema = Joi.object()
  .keys({
    ...
    EMAIL_FROM_ADDRESS: Joi.string().description('from field in the emails sent by the app'),
    EMAIL_FROM_NAME: Joi.string().description('from name in the emails sent by the app'),
    ...
    COOKIE_DOMAIN: Joi.string().description('domain for cookies'),
  })
  .unknown();
...
module.exports = {
  ...
  deployment: {
    defaultAdminEmail: envVars.DEFAULT_ADMIN_EMAIL,
    defaultAdminPassword: envVars.DEFAULT_ADMIN_PASSWORD,
